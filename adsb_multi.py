...
def get_json(base_url, file):
    try:
        with urllib.request.urlopen(base_url + file) as url:#!/usr/bin/python3
import collections
...
# --- Configuration (Direct File Access) ---
DATA_SOURCES = {
...
graph_category adsb
graph_vlabel count
tis_b.label TIS-B Traffic
anon.label Anonymous Mode
